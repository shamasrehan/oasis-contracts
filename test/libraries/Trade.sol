...
library Trade {
    ...
    using Sign for OPv1Signing.Scheme;
    ...
    ) internal pure returns (OPv1Trade.Data memory trade) {
        trade = OPv1Trade.Data({
    ...
    function toOrder(OPv1Trade.Data memory trade, IERC20[] memory tokens)
        internal
        pure
        returns (OPv1Order.Data memory)
    {
