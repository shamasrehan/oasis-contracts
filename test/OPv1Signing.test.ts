...
describe("OPv1Signing", () => {
  ...
  beforeEach(async () => {
    const OPv1Signing = await ethers.getContractFactory(
      "OPv1SigningTestInterface",
    );

    signing = await OPv1Signing.deploy();
  ...
  describe("domainSeparator", () => {
    ...
    it("should have a different replay protection for each deployment", async () => {
      ...
      const signing2 = await OPv1Signing.deploy();
  ...
  describe("recoverOrderFromTrade", () => {
    ...
    describe("uid uniqueness", () => {
      it("invalid EVM transaction encoding does not change order hash", async () => {
        ...
        // a valid transaction.
        // Computing OPv1's orderUid requires copying 32-byte-encoded addresses
