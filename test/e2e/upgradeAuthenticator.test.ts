...
describe("E2E: Upgrade Authenticator", () => {
  ...
  it("should upgrade authenticator", async () => {
    const OPv1AllowListAuthenticationV2 = await ethers.getContractFactory(
      "OPv1AllowListAuthenticationV2",
      deployer,
    );
    // Note that, before the upgrade this is actually the old instance
    const authenticatorV2 = OPv1AllowListAuthenticationV2.attach(
