 ...
 */
export const PRE_SIGNED = ethers.utils.id("OPv1Signing.Scheme.PreSign");
...
/**
 * Encodes the necessary data required for the Oasis Protocol contracts to
...
/**
 * Decodes a OPv1 EIP-1271-type signature into the actual EIP-1271 signature
