...
/**
 * Oasis Protocol v1 order cancellation data.
 */
...
/**
 * The EIP-712 type fields definition for a Oasis Protocol v1 order.
 */
...
/**
 * The EIP-712 type hash for a Oasis Protocol v1 order.
 */
