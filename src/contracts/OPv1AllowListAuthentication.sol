...
import "./libraries/OPv1EIP1967.sol";
import "./mixins/Initializable.sol";
import "./mixins/StorageAccessible.sol";

/// @title Oasis Protocol v1 Access Control Contract
/// @author Oasis Developers
contract OPv1AllowListAuthentication is
    OPv1Authentication,
    Initializable,
    StorageAccessible
{
    ...
    modifier onlyManager() {
        require(manager == msg.sender, "OPv1: caller not manager");
        _;
    }
    ...
    modifier onlyManagerOrOwner() {
        require(
            manager == msg.sender || OPv1EIP1967.getAdmin() == msg.sender,
            "OPv1: not authorized"
        );
        _;
    }
