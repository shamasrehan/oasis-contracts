> [!IMPORTANT]  
> This repository is in the process of being migrated to the [Foundry](https://getfoundry.sh) Ethereum application development environment. Developers wishing to integrate and/or develop on the Oasis Protocol smart contracts with hardhat should refer to tag [`v1.6.0`](https://github.com/oasisprotocol/contracts/releases/tag/v1.6.0) [Browse files](https://github.com/oasisprotocol/contracts/tree/1d673839a7402bdb2949175ebb61e8b5c4f39ecb).

# Oasis Protocol

This repository contains the Solidity smart contract code for the **Oasis Protocol**.
...
For a single contract, named `OPv1Contract` and located at address `0xFeDbc87123caF3925145e1bD1Be844c03b36722f` in the example:

```sh
npx hardhat tenderly:verify --network $NETWORK OPv1Contract=0xFeDbc87123caF3925145e1bD1Be844c03b36722f
```
